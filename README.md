...
**Is it fine with App Store?** Yes, it is... as long as your content corresponds to what application is intended for and you don't ask user to click some button to update the web content. For more details please refer to [this wiki page](https://github.com/snipking/cordova-hot-code-push/wiki/App-Store-FAQ).
...
For production build do not forget to add the following to your `config.xml` file as it is a required property. Checkout the [wiki](https://github.com/snipking/cordova-hot-code-push/wiki/Cordova-config-preferences) for more information:
...
All documentation can be found in details in our [Wiki on GitHub](https://github.com/snipking/cordova-hot-code-push/wiki).

If you have some questions/problems/suggestions - don't hesitate to post a [thread](https://github.com/snipking/cordova-hot-code-push/issues). If it's an actual issue - please, follow [this guide](https://github.com/snipking/cordova-hot-code-push/wiki/Issue-creation-guide) on how to do that properly.
